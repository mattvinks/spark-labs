...
```bash
    $   ~/spark/bin/spark-submit --class 'x.ProcessFiles'   --driver-class-path logging/  target/scala-2.11/testapp_2.11-1.0.jar    's3n://elephantscale-public/data/twinkle/100M.data'
```
