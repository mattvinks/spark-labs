...
<br>
Usage:
spark-submit --class 'spark.advanced.Clickstream' --master spark://localhost:7077 target/spark.advanced-0.0.1-SNAPSHOT-jar-with-dependencies.jar  <files to process>
