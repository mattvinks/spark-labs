...
* s3n://elephantscale-public/data/text/twinkle/200M.data
...
* https://s3.amazonaws.com/elephantscale-public/data/text/twinkle/100M.data
* https://s3.amazonaws.com/elephantscale-public/data/text/twinkle/200M.data

**=> Try loading these files.  Measure performance time before and after caching.**  

```scala
    // scala
    val f = sc.textFile("s3n://elephantscale-public/data/text/twinkle/200M.data")
